...
from jet.dashboard.dashboard_modules import google_analytics, send_mail
...
class JagdreisencheckDashboard(Dashboard):
    columns = 3
    ...
    def init_with_context(self, context):
        ...
        self.available_children.append(send_mail.SendMailModule)
        self.available_children.append(modules.LinkList)
        self.available_children.append(modules.Feed)
