# -*- coding: utf-8 -*-
# Generated by Django 1.11.16 on 2019-01-09 17:55
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('travelling', '0017_auto_20190109_1221'),
    ]
    ...
    operations = [
        migrations.AddField(
            ...
            name='budget',
            field=djmoney.models.fields.MoneyField(decimal_places=2, default=None, default_currency='EUR', max_digits=8, null=True, verbose_name='Budget per Hunter'),
        ),
        migrations.AddField(
            model_name='travelinquiry',
        ...
        migrations.AddField(
            model_name='travelinquiry',
            name='game',
            field=models.ManyToManyField(to='travelling.Game', verbose_name='Game to be hunted'),
        ),
        migrations.AddField(
            model_name='travelinquiry',
            name='num_of_hunters',
            field=models.IntegerField(null=True, verbose_name='Number of Hunters'),
        ),
        migrations.AddField(
            model_name='travelinquiry',
            name='num_of_non_hunters',
            field=models.IntegerField(null=True, verbose_name='Number of accompanying Persons'),
        ),
        migrations.AddField(
            model_name='travelinquiry',
            name='time_end',
            field=models.DateField(null=True, verbose_name='When would you like to end the trip?'),
        ),
        migrations.AddField(
            model_name='travelinquiry',
            name='time_start',
            field=models.DateField(null=True, verbose_name='When would you like to start the trip?'),
        ),
        migrations.AlterField(
            model_name='travelinquiry',
            name='inquiry',
            field=ckeditor.fields.RichTextField(null=True, verbose_name='Further Details, Wishes & Questions'),
        ),
    ]
